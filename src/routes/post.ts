...
router.get("/:identitfier/:slug", user, getPost);
router.post("/:identitfier/:slug/comments", user, auth, commentOnPost);
router.get("/:identitfier/:slug/comments", user, getPostComments);
